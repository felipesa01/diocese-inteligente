...
import { CarouselComponent } from './components/modalsInfo/modal-info-monitor-areas-publicas/carousel/carousel.component';
import { ZelaMainComponent } from './applications/zeladoria/zela-main/zela-main.component';
import { ModalSelectApplicationComponent } from './components/modal-select-application/modal-select-application.component';
...
@NgModule(
    {
        declarations: [
            ...
            BcMainContainerComponent,
            MonapMainContainerComponent,
            ModalInfoMonitorAreasPublicasComponent,
            CarouselComponent,
            ZelaMainComponent,
            ModalSelectApplicationComponent,
            CultMainComponent,
            ModalInfoZeladoriaComponent,
            ModalInfoZoldarmadilhasComponent,
            DioceseMainComponent,
            ModalInfoIgrejasComponent
        ],
